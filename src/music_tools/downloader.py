...
def download_song(song_info: dict, download_url: str, save_dir: str = "~/Music") -> Path | None:
    """
    Downloads a song to the specified directory.
    
    Args:
        song_info: A dictionary containing song metadata (name, artists).
    ...
    try:
        ...
        artist_name = song_info.get("artists", [{}])[0].get("name", "Unknown Artist")
        song_name = song_info.get("name", "Unknown Title")
